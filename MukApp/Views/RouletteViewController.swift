...
extension RouletteViewController: UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        ...
        let exampleRes: [String] = ["배가 안고파져버렸다", "크루아상 전문 한정식집", "생선없는 초밥집", "배가 불러지는 마법의 알약", "맛집보단 정신적 배부름", "냉동실에 있는 닭가슴살", "드레싱 없는 샐러드", "마라탕 먹지 마라탕", "팅!팅! 탱!탱! 후라이팬", "탕! 수육", "탕 수!육", "탕! 후루", "딸기가 좋아, 딸기가 좋아",  "단백질 쉐이크", "소금없는 소금빵", "빵 없는 소금빵", "딩 동 냉-동", "올 때 메로나", "아이스 핫초코", "바질없는 바질 페스토", "패티없는 햄버거", "얼리지 않은 삼다수바", "팥없는 붕어 싸만코"]
